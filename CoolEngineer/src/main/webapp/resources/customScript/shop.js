...
function select_shop_category() {
	...
	var so2 = new Array("여성의류", "여성신발", "여성가방", "남성의류", "남성신발", "남성가방", "시계", "쥬얼리", "언더웨어/잠옷", "지갑/벨트", "여행가방", "패션잡화", "신생아의류", "아동의류", "유아의류", "유아동신발", "유아동잡화", "임부복/소품");
	...
	var so6 = new Array("기저귀", "출산/돌기념품", "유아목욕", "장난감", "분유", "이유용품", "유아위생용품", "아동의류", "수유용품", "실내용품", "유아동신발", "이유식/영양제", "외출용품", "유아의류", "유아동잡화", "유아가구/침구", "임부복/소품", "신생아의류");
	...
	var so9 = new Array("TV", "노트북", "스마트기기", "냉장고", "카메라", "모니터", "휴대폰", "세탁기", "영상가전", "데스크탑", "태블릿", "주방가전", "음향가전", "프린터/복합기", "게임", "PC부품", "컴퓨터 주변기기", "생활가전");
