...
function select_shop_category() {
	...
	var so4 = new Array("스포츠의류", "등산/아웃도어", "스키/보드", "자동차용품", "스포츠잡화", "자전거", "골프", "스포츠신발", "캠핑", "낚시", "자동차기기");
	...
	var so8 = new Array("침실가구", "거실가구", "서재/사무용가구", "유아동가구", "리모델링가구", "수납가구", "주방가구", "커튼/블라인드", "침구", "인테리어소품", "카페트/러그", "조명");
	var so9 = new Array("TV", "노트북", "스마트기기", "냉장고", "카메라", "모니터", "휴대폰", "세탁기", "영상가전", "데스크탑", "태블릿", "주방가전", "음향가전", "프린터/복합기", "게임", "PC부품", "컴퓨터주변기기");
