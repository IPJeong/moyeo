							...
							<div class="panel panel-default">
								...
								<div class="panel-body padding-0" style="height: 270px;">
									<div class="chart-holder" id="dashboard-line-1"
										style="height: 180px;">
										<img src="../resources/assets/images/gallery/pin.jpg"
											width="180x" height="130px" style="magin: 5px 5px"><font
											size="3">XENO_B.C - 영등포 볼링</font><br> <br>
										<br>
										<h3>
						...
						<div class="col-md-55" style="margin-top: 10px;">
							<div class="panel panel-default">
								...
								<div class="panel-body padding-0" style="height: 550px;">
									<div class="chart-holder" id="dashboard-line-1">
										<div class="main">
											<img src="../resources/assets/images/gallery/피카츄.png"
												width="150px" height="110px" style="magin: 5px 5px">피카츄
											<a href="#">[상세보기]</a><br>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[모임장]<br>
											<img src="../resources/assets/images/gallery/라이츄.png"
												width="150px" height="110px" style="magin: 5px 5px">라이츄
											<a href="#">[상세보기]</a><br>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[회원]<br>
											<img src="../resources/assets/images/gallery/파이리.png"
												width="150px" height="110px" style="magin: 5px 5px">파이리
											<a href="#">[상세보기]</a><br>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[회원]<br>
											<img src="../resources/assets/images/gallery/꼬부기.jpg"
												width="150px" height="110px" style="magin: 5px 5px">꼬부기
											<a href="#">[상세보기]</a><br>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[회원]<br>
										</div>
									</div>
						...
						<div class="panel panel-default">
							...
							<div class="panel-body padding-0"
								...
								<div class="chart-hodler"
									...
									<img src="../resources/assets/images/gallery/coffee.png"
										width="600px" height="250px" style="float: left;"><br>
									<div style="width: 500px; float: left;">#자전거 #운동 #산책 #친목
										#라이딩</div>
								</div>


								<p style="margin-left: 650px; margin-top: -60px;">
									<a href="../moim/moim_cheif_member.jsp"><input
										type="button" value="모임가입"
										style="width: 100px; height: 30px; font-size: 13px"></a> <a
										href="../moim/moim_schedule.jsp"><input type="button"
										value="모임탈퇴"
										style="width: 100px; height: 30px; font-size: 13px"></a> <input
										type="button" value="모임신고"
										style="width: 100px; height: 30px; font-size: 13px"
										onclick="window.location='moimReportMain'">
								</p>
								<br>
