...
<div class="col-md-6 page-title">                    
      ...
      <div class="col-md-6 " style="margin:auto;float:none;">
          <h2 style="margin:auto;"><span class="fa fa-cogs"></span> 마이페이지</h2><br>
          <form:form action="changeMyInfo" name="myPage" class="form-horizontal" onsubmit="return chgMyInfo();">
          <div class="panel panel-default">                                
              <div class="panel-body">
                  ...
                  <div class="text-center" id="user_image">
                      <img src="${dto.proPicPath}/${dto.proPicName}" class="img-thumbnail" style="width:250px;"/>
                  </div>                                    
              </div>
              <div class="panel-body form-group-separated">
                  ...
                  <div class="form-group" style="float:none;">                                        
                      <div class="col-md-8" style="margin:auto;float:none;">
                          <a href="#" class="btn btn-info btn-block " data-toggle="modal" data-target="#modal_change_photo" >프로필사진 바꾸기</a>
                      </div>
                  </div>
                      ...
                      <div class="col-md-9 col-xs-6">
                      	  <table style="width:100%">
                      	  	<tr>
                      	  		<th style="width:80%">
                      	  			<div id="nameInput">
                      	  				<input type="hidden" name="pro1" value="x"/>
                      	  				<input type="hidden" name="name" value="${dto.name}"/>
		                         		${dto.name}
		                         	</div>
		                        </th>
		                        <th style="width:20%">
		                        	<div id="nameBtn">
		                        		<button type="button" id="nameInBtn" class="btn btn-default" ><span class="glyphicon glyphicon-pencil"></span></button>
		                        		<button type="button" id="nameInBtn1" class="btn btn-default" ><span class="glyphicon glyphicon-pencil"></span></button>
		                        	</div>
		                        </th>
		                     </tr>
                          </table>
                      	  	...
                      	  	<tr>
                      	  		<th style="width:80%">
	                         		<div class="col-md-12" style="padding:0px;" id="addInput">
	                         			<input type="hidden" name="pro2" value="x"/>
	                         			<input type="hidden" name="address" value="${dto.address}"/>                                                                                
	                                     ${dto.address}
	                                 </div>              	
		                        </th>
		                        <th style="width:20%">
		                        	<button type="button" class="btn btn-default" id="addInBtn"><span class="glyphicon glyphicon-pencil"></span></button>
		                        	<button type="button" class="btn btn-default" id="addInBtn1"><span class="glyphicon glyphicon-pencil"></span></button>
		                        </th>
		                     </tr>
                          </table>
                      </div>
                      ...
                      <div class="col-md-9 col-xs-7">
                          <table style="width:100%">
                      	  	<tr>
                      	  		<th style="width:80%">
                      	  			<div id="emailInput">
                      	  				<input type="hidden" name="pro3" value="x"/>
                      	  				<input type="hidden" name="email" value="${dto.email}"/>
		                         		${dto.email}
		                         	</div>	
		                        </th>
		                        <th style="width:20%">
		                        	<button type="button" class="btn btn-default" id="emInBtn"><span class="glyphicon glyphicon-pencil"></span></button>
		                        	<button type="button" class="btn btn-default" id="emInBtn1" ><span class="glyphicon glyphicon-pencil"></span></button>
		                        </th>
		                     </tr>
                          </table>
                      </div>
                      ...
                      <div class="col-md-9 col-xs-7">
                          <table style="width:100%">
                      	  	<tr>
                      	  		<th style="width:80%">
                      	  			<div id="telInput">
                      	  				<input type="hidden" name="pro4" value="x"/>
                      	  				<input type="hidden" name="tel" value="${dto.tel}"/>	
		                         		${dto.tel}
		                         	</div>
		                         	<div id="telMsg"></div>
		                        ...
		                        <th style="width:20%">
		                        	<button type="button" class="btn btn-default" id="telInBtn"><span class="glyphicon glyphicon-pencil"></span></button>
		                        	<button type="button" class="btn btn-default" id="telInBtn1"><span class="glyphicon glyphicon-pencil"></span></button>
		                        </th>
		                     </tr>
                          </table>
                      </div>
                  ...
                  <div class="form-group">
                  	  <div class="col-md-8" style="margin:auto;float:none;">
	                      <div class="col-md-6" style="margin:0px;padding:0px;padding-right:2px;padding-bottom:5px;border:0px;">
	                          <button type="submit" class="btn btn-primary col-md-12" id="chnInfo" >회원정보수정</button>
	                      </div>
	                      <div class="col-md-6" style="margin:0px;padding:0px;padding-left:2px;padding-bottom:10px;border:0px;">
           ...
           <div class="col-md-12 " style="padding:0px;">
		  	  <h2><span class="fa fa-github"></span> 가입한 모임</h2>
		           ...
		           <table class="table table-bordered" style="border:1px solid #E0E0E0">
		               ...
		               <tbody>
		               		<c:if test="${cnt > 0}">
				                   ...
				                   <tr>				                       
				                       <td><a href="/moyeo/six/moimMain/moimMain?group_num=${dto2.groupNum}">${dto2.groupName}</a></td>
				                       <td>${dto2.groupInte1} - ${dto2.groupInte2}</td>
				                       <td>${dto2.groupLoca}</td>
				                   </tr>
			                   </c:forEach>
		                   </c:if>		                   
		               </tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="text-center" id="user_image">
                      <img src="${dto.proPicPath}/${dto.proPicName}" class="img-thumbnail" style="width:70%;"/>
                  </div>                        
            </div>                    
            
            <form:form class="form-horizontal" action="changeProImg" method="post" name="changeProImg" modelAttribute="uploadForm" enctype="multipart/form-data" onsubmit="changeProImg();">
	            <div class="modal-body form-horizontal form-group-separated">                
	                <div class="form-group">
	                    <label class="col-md-4 control-label">New Photo</label>
	                    <div class="col-md-8">
	                        <input type="file" class="fileinput btn-info" name="files[0]" id="cp_photo" data-filename-placement="inside" title="사진 선택">                                                       
	                        <label class="check" style="margin-left:20px"><input type="checkbox" class="icheckbox" name="noImg" value="${dto.gender}" />프로필 사진 선택 안함</label>
	                    </div>                           
	                </div>                         
	            </div>            
...
<!-- 비밀번호 모달 -->
<div class="modal animated fadeIn" id="modal_change_pw" tabindex="-1" role="dialog" aria-labelledby="smallModalHead" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
            ...
            <form:form class="form-horizontal" action="changePw" method="post" name="proPwCng">
            <div class="modal-body form-horizontal form-group-separated">                
                <div class="form-group">
                    <label class="col-md-4 control-label">현재 비밀번호</label>
                    <div class="col-md-4">
                        <input type="password" name="passwd" class="form-control" onkeyup="curPwChk()" required/>
                    </div>
                    <div class="col-md-4" id="curPwChk" style="border:0px;">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input type="password" name="password" class="form-control" onkeyup="passChk2()" required/>
                    </div>
                    <div class="col-md-4" id="proPwChk2" style="border:0px;">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input type="password" name="re_password" class="form-control" onkeyup="passChk2()" required/>
                    </div>
                    <div class="col-md-4" id="proPwChk" style="border:0px;">
...
<script type="text/javascript" src="/moyeo/resources/resource/js/plugins/bootstrap/bootstrap-timepicker.min.js"></script>
<script type="text/javascript" src="/moyeo/resources/resource/js/plugins/bootstrap/bootstrap-colorpicker.js"></script>
