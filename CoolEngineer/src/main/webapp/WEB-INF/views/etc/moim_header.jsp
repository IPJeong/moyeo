...
<script type="text/javascript"
	src="../resources/js/plugins/jquery-mousewheel-master/jquery.mousewheel.min.js"></script>
<script type="text/javascript"
...
<script type="text/javascript"
	src="../resources/js/plugins/moment.min.js"></script>
<script type="text/javascript"
...
<script type="text/javascript" src="../resources/js/demo_dashboard_x.js"></script>
<!-- END TEMPLATE -->
<!-- END SCRIPTS -->
