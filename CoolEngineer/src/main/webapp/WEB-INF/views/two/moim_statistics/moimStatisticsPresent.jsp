		...
		<div class="col-md-56" style="margin-top: 10px;">
			<div class="panel panel-default">
 			...
 			<c:if test="${term.equals('month')}">
				<div style="width:80%; height:30%; margin-top:10%; margin-left:10%;">
					...
					function drawChart() {
					   ...
					   // Set chart options
					   var options = {'title' : '1개월간 모임원의 출석일수 통계',
					      hAxis: {
					         title: '주'
					      },
					      vAxis: {
				...
				<table class="table table-bordered" style="width:90%; margin-left:5%; margin-top:18%;">
					...
					<tr>
						<td style="background:white; border:1px solid #D9E5FF;" align="center">출석일수</td>
 			...
 			<c:if test="${term.equals('year')}">
				<div style="width:80%; height:30%; margin-top:10%; margin-left:-7%;">
					...
					function drawChart() {
					   ...
					   // Set chart options
					   var options = {'title' : '1년간 모임원의 출석일수 통계',
					      hAxis: {
					         title: '월'
					      },
					      vAxis: {
 			...
 			<c:if test="${term.equals('best10')}">
 				<br><br>
 				<h2 style="margin-top:9%;"><center>출석일수가 많은 모임원 BEST 10</center></h2>
 				<table class="table table-bordered" style="width:90%; margin-left:5%; margin-top:3%;">	
 						<tr>
	 					 	...
	 					 	<td style="border:1px solid #D9E5FF; width:25%;" align="center">이름</td>
	 					 	<td style="border:1px solid #D9E5FF; width:25%;" align="center">아이디</td>
	 					 	<td style="border:1px solid #D9E5FF; width:15%;" align="center">출생년도</td>
 					...
 					<c:forEach var="dto" items="${dtos}">
	 					<tr>
	 						...
	 						<td style="background:white; border:1px solid #D9E5FF;" align="center">${dto.name}</td>
	 						<td style="background:white; border:1px solid #D9E5FF;" align="center">${dto.mem_id}</td>
	 						<td style="background:white; border:1px solid #D9E5FF;" align="center">
	 							<fmt:formatDate type="both" pattern="yyyy-MM-dd" value="${dto.birth}" />
	 						</td>
	 						<td style="background:white; border:1px solid #D9E5FF;" align="center">${dto.gender}</td>
