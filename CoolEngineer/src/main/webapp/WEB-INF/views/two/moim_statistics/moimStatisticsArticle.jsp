			...
			<c:if test="${term.equals('month')}">
				<div style="width:80%; height:30%; margin-top:10%; margin-left:10%;">
					...
					function drawChart() {
					   ...
					   // Set chart options
					   var options = {'title' : '1개월간 게시글의 조회수 통계',
					      hAxis: {
					         title: '주'
					      },
					      vAxis: {
				...
				<table class="table table-bordered" style="width:90%; margin-left:5%; margin-top:18%;">
					...
					<tr>
						<td style="background:white; border:1px solid #D9E5FF;" align="center">조회수</td>
 			...
 			<c:if test="${term.equals('year')}">
				<div style="width:80%; height:30%; margin-top:10%; margin-left:-7%;">
					...
					function drawChart() {
					   ...
					   // Set chart options
					   var options = {'title' : '1년간 게시글의 조회수 통계',
					      hAxis: {
					         title: '월'
					      },
					      vAxis: {
 			...
 			<c:if test="${term.equals('best10')}">
 				<br><br>
 				<h2 style="margin-top:9%;"><center>조회수가 많은 게시글 BEST 10</center></h2>
 				<table class="table table-bordered" style="width:90%; margin-left:5%; margin-top:3%;">	
 						<tr>
	 					 	<td style="border:1px solid #D9E5FF; width:10%;" align="center">순위</td>
	 					 	<td style="border:1px solid #D9E5FF; width:50%;" align="center">제목</td>
	 					 	<td style="border:1px solid #D9E5FF; width:15%;" align="center">등록일</td>
	 					 	<td style="border:1px solid #D9E5FF; width:15%;" align="center">아이디</td>
	 					 	<td style="border:1px solid #D9E5FF; width:10%;" align="center">조회수</td>	 	
	 					</tr>
	 			<c:if test="${cnt > 0}">
 					<c:forEach var="dto" items="${dtos}">
	 					<tr>
	 						<td style="background:white; border:1px solid #D9E5FF;" align="center">${dto.hit_rank}</td>
	 						<td style="background:white; border:1px solid #D9E5FF;" align="center">${dto.title}</td>
	 						<td style="background:white; border:1px solid #D9E5FF;" align="center">
	 							<fmt:formatDate type="both" pattern="yyyy-MM-dd" value="${dto.reg_date}" />
	 						</td>
	 						<td style="background:white; border:1px solid #D9E5FF;" align="center">${dto.mem_id}</td>
	 						<td style="background:white; border:1px solid #D9E5FF;" align="center">${dto.hit}</td>
	 					</tr>
 					</c:forEach>
 				</c:if>
 				<c:if test="${cnt == 0}">
