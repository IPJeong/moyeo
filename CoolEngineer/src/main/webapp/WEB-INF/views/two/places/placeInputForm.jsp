...
function select_loc_category() {
	...
	var lc1 = document.placeinputform.loc_category1;
	var lc2 = document.placeinputform.loc_category2;
...
function placeInputFormSubmit() {
	if(!document.placeinputform.files[0].value) {
	...
	<div class="col-md-56" style="margin-top:30px; margin-bottom:30px; margin-left:20%; height:820px;">
		<div class="panel panel-default">
			...
			<div style="width:80%;">
				...
				<form:form action="placeInputPro" name="placeinputform" method="post" class="form-horizontal" style="margin-left:20%;" modelAttribute="uploadForm" enctype="multipart/form-data">
					<fieldset>
						<legend>장소정보 등록</legend><br>
						...
						<div class="form-group">
							...
							<div class="col-lg-10">
								<textarea class="form-control" rows="17" name="place_detail" maxlength="2000"></textarea>
						...
						<div class="form-group">
							<div class="col-lg-10 col-lg-offset-2">
								<button type="submit" class="btn btn-primary" onclick="return placeInputFormSubmit();">입력</button>
