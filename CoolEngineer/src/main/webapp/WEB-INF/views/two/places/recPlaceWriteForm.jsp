	...
	<div class="col-md-56" style="margin-top:30px; margin-bottom:30px; margin-left:20%; height:800px;">
		<div class="panel panel-default">
			...
			<div style="width:80%;">
				...
				<form action="recPlaceWritePro" name="recplacewriteform" class="form-horizontal" style="margin-left:20%;">
					...
					<fieldset>
						...
						<div class="form-group">
							<div class="col-lg-10 col-lg-offset-2">
								...
								<input type="button" class="btn btn-info" value="목록" onclick="window.location='placeContentForm?place_num=${place_num}'">
							</div>
						</div>
					</fieldset>
				</form>
