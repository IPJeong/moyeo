...
<div class="row">
	<div class="col-md-12">
			...
			<div class="panel-body">
				...
				<div class="table-responsive">
					<table class="table">
						<thead>
							<tr>
								<th class="subject" style="border-color: #d8bbff;"><font size="3">제 목</font></th>
								...
								<c:forEach var="dto" items="${dtos}">
									<tr>
										<td style="border-color: #d8bbff;"><a
											href="notice_content?noti_num=${dto.noti_num}&pageNum=${pageNum}&number=${number+1}"><font
		...
		<input class="btn btn-info" style="font-size: 1.5em;" type="button"
			value="글쓰기" onclick="window.location='notice_write'">
