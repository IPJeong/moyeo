...
<tbody><tr height="30">
    ...
    <td width="20"></td>
    <td><a href="/moyeo/six/shop/productDetail?product_num=${product_num}" target="_blank" class="item_title">${product_name}</a></td>
</tr>
</tbody></table>
...
<tbody><tr height="30">
  ...
  %>
    <td><span class="date"> <%= cal.get(Calendar.YEAR) %>-<%= cal.get(Calendar.MONTH) + 1 %>-<%= cal.get(Calendar.DATE) %></span></td>
</tr>
</tbody></table>
