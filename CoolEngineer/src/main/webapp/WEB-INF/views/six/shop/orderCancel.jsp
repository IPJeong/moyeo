...
</select><a class="selectBox select selectBox-dropdown" style="display: inline-block;" title="" tabindex="0"><span class="selectBox-label">주문취소</span><span class="selectBox-arrow"></span></a>
...
<!-- 환불정보 start //-->
<div id="return_layer" style="display: inline;">
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="box_bg">
<tbody><tr height="30"><td></td></tr>
</tbody></table>
...
<tbody><tr>
    <td><img src="/moyeo/resources/resource/img/shop/5help_arrow.gif"></td>
    <td width="5"></td>
    <td><img src="/moyeo/resources/resource/img/shop/5t4.gif"></td>
</tr>
</tbody></table>
...
<tbody><tr height="30">
    ...
    <td bgcolor="#e4e4e4"></td>
    <td></td>
    <td><input type="text" name="order_refund_holder" value="" class="input" style="width:100px;"></td>
</tr>
<tr><td colspan="4" height="1" bgcolor="#bbbbbb"></td>
</tr><tr height="30">
...
<tr><td colspan="4" height="1" bgcolor="#bbbbbb"></td>
    ...
    <td bgcolor="#e4e4e4"></td>
    <td></td>
    <td><select id="order_refund_code" name="order_refund_code" class="select"><option value="">선택하세요.</option><option value="02">산업은행</option><option value="03">기업은행</option><option value="04">국민은행</option><option value="05">외환은행</option><option value="07">수협중앙회</option><option value="11">농협중앙회</option><option value="12">단위농협</option><option value="16">축협중앙회</option><option value="20">우리은행</option><option value="21">신한은행</option><option value="23">제일은행</option><option value="25">하나은행</option><option value="26">신한은행</option><option value="27">한국씨티은행</option><option value="31">대구은행</option><option value="32">부산은행</option><option value="34">광주은행</option><option value="35">제주은행</option><option value="37">전북은행</option><option value="38">강원은행</option><option value="39">경남은행</option><option value="41">비씨카드</option><option value="45">새마을금고</option><option value="48">신협</option><option value="53">씨티은행</option><option value="54">홍콩상하이은행</option><option value="64">산림조합</option><option value="71">우체국</option><option value="81">하나은행</option><option value="83">평화은행</option><option value="87">신세계</option><option value="88">신한은행</option><option value="209">동양종합금융증권</option><option value="218">현대증권</option><option value="230">미래에셋증권</option><option value="240">삼성증권</option><option value="243">한국투자증권</option><option value="247">우리투자증권</option><option value="262">하이투자증권</option><option value="263">HMC투자증권</option><option value="266">SK증권</option><option value="267">대신증권</option><option value="269">한화증권</option><option value="270">하나대투증권</option><option value="278">신한금융투자</option><option value="279">동부증권</option><option value="280">유진투자증권</option><option value="287">메리츠증권</option><option value="291">신영증권</option></select></td>
</tr>
</tbody></table>
