									...
									<div class="chart-holder"
										...
										<div style="width: 50%; height: 100%; float: left">
											<p
												...
												<font color="#1d1f21">모임명 :</font> ${dtos[stat.index].meeting_title}
											</p>
											<p
												style="text-align: left; margin-left: 20px; font-size: 20px;">
												<font color="#1d1f21">일시 :</font> ${dtos[stat.index].meeting_date}
											</p>
											<p
												style="text-align: left; margin-left: 20px; font-size: 20px;">
												<font color="#1d1f21">장소 :</font> ${dtos[stat.index].loc_detail}
											</p>
											<p
												style="text-align: left; margin-left: 20px; font-size: 20px;">
												<font color="#1d1f21">목표인원 :</font> ${dtos[stat.index].meeting_pernum}
											</p>
										</div>
