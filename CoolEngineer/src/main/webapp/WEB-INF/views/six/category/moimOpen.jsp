...
<script type="text/javascript">
	function select_recpla_category() {
		...
		var ct13 = new Array("삼성라이언즈", "기아타이거즈", "롯데자이언츠", "두산베어스", "LG트윈즈",
...
<br>
<form name="locationselectform" action="moimOpenPro">
		...
		<div class="col-md-13-2">
			<div class="panel panel-default"
				...
				<div class="panel-body padding-0"
					...
					</select> <select name="loc_category2" class="form-control-1 select"
			...
			<div class="panel panel-default"
				...
				<div class="panel-body padding-0"
					...
					</select> <select name="recpla_category2" class="form-control-1 select"
						style="width: 49%; margin-left: 0.35%;" required>
						<option value="">선택하세요</option>
					</select>
				</div>
