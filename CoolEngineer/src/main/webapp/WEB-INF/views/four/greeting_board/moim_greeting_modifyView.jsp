					...
					<form action="moim_greeting_modifypro" method="post" name="modifyform" class="form-horizontal">
						...
						<fieldset>
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<input type="text" class="form-control" name="title" id="subject" placeholder="" value="${dto.greeting_title}" required>
								</div>
						...
						<!-- 	<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<textarea class="form-control" name="content" rows="15" id="textArea" required>${dto.greeting_content}</textarea>
								</div>
							</div>
							<div class="form-group">
