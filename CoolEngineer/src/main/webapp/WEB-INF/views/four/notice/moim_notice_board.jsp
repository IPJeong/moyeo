					...
					<div class="chart-holder" id="dashboard-bar-1"
						...
						<form>
							<div style="float: right; margin-right: 5%;">
								<input class="btn btn-default" value="글쓰기" type="button"
									onclick="location.href='moim_notice_write_form'">
							</div>
						</form>
						<br>
						<br>
									...
									<c:forEach var="dto" items="${dtos}">
										<tr>
											...
											<td><fmt:formatDate type="both"
													pattern="yyyy-MM-dd HH:mm" value="${dto.group_noti_date}" />
											</td>
											<td>${dto.hit}</td>
										</tr>
									</c:forEach>
							...
							<ul
								...
								<c:if test="${cnt > 0}">
									...
									<c:if test="${startPage > pageBlock}">
										<li class=""><a
											href="moim_notice_board?pageNum=${startPage - pageBlock}"><font
												size="3"> «</font></a></li>
									</c:if>
									...
									<c:forEach var="i" begin="${startPage}" end="${endPage}">
										...
										<c:if test="${i != currentPage}">
											<li class=""><a href="moim_notice_board?pageNum=${i}"><font
													size="3">${i}</font></a></li>
										</c:if>
