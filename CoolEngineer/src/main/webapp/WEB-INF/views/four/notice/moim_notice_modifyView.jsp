					...
					<form action="moim_notice_modifypro" method="post" name="modifyform" class="form-horizontal">
						...
						<fieldset>
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<input type="text" class="form-control" name="title" id="subject" placeholder="" value="${dto.group_noti_title}">
								</div>
						...
						<!-- 	<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<textarea class="form-control" name="content" rows="15" id="textArea">${dto.group_noti_content}</textarea>
								</div>
							</div>
							<div class="form-group">
